...
(test testing-day-of-week-equal
  (is-true (same-dow "2011.12.5" :monday))
  (is-true (same-dow :tuesday "2011.12.6"))
  (is-true (same-dow (utime-from-string "2011.12.7") :wednesday))

  (is-true (same-dow "2011.12.8" :thursday))
  (is-true (same-dow :friday "2011.12.9"))
  (is-true (same-dow "2011.12.16" "2011.12.9"))
  (is-true (same-dow "2011.12.10" :saturday))

  (is-true (same-dow "2011.12.11" :sunday))
